...
<div style="padding:10px 10px 10px 10px">
	<form id="redAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>红包key:</td>
	            <td><input class="easyui-textbox" type="text" id="red_package_key" name="redkey" value="" data-options="required:true" readonly="readonly" style="width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>排行榜key:</td>
	            <td><input class="easyui-textbox" type="text" id="topn_key" name="topnkey" value="" data-options="required:true" readonly="readonly" style="width: 280px;"></input></td>
	        </tr>
	        <tr> 
	            <td>红包总金额:</td>
...
<script type="text/javascript">
	...
	var redAddPage  = {
			submitForm : function (){
				$.post("/red/saveOrUpdate",$("#redAddForm").serialize(), function(data){
					if(data.status == 200){
