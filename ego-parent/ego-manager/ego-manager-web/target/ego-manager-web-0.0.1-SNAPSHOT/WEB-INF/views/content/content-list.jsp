...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contentList" data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'/content/getData',queryParams:{categoryId:0}">
		    <thead>
		        <tr>
...
var contentListToolbar = [{
    ...
    iconCls:'icon-edit',
    handler:function(){
    	var ids = Ego.getSelectionsIds("#contentList");
    	if(ids.length == 0){
