...
var _INLINE_TAG_MAP = _toMap('a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var'),
	...
	_FILL_AEgoR_MAP = _toMap('checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected'),
...
var _GET_SET_AEgoRIBUTE = _getSetAttrDiv.className !== 't';
function _getAttr(el, key) {
	key = key.toLowerCase();
	var val = null;
	if (!_GET_SET_AEgoRIBUTE && el.nodeName.toLowerCase() != 'script') {
...
function _ajax(url, fn, method, param, dataType) {
	...
	var xhr = window.XMLHttpRequest ? new window.XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHEgoP');
...
SWFUpload.prototype.initSettings = function () {
	...
	this.ensureDefault("button_action", SWFUpload.BUEgoON_ACTION.SELECT_FILES);
...
// Public: setHEgoPSuccess changes the http_success setting
SWFUpload.prototype.setHEgoPSuccess = function (http_status_codes) {
	if (typeof http_status_codes === "string") {
		http_status_codes = http_status_codes.replace(" ", "").split(",");
	}

	this.settings.http_success = http_status_codes;
	this.callFlash("SetHEgoPSuccess", [http_status_codes]);
};
