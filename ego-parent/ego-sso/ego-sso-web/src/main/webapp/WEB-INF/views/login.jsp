...
<!--[if IE 6]> 
<link href="<%=basePath%>/css/main.ie6.css" rel="stylesheet" type="text/css" />
<![endif]-->
<!--[if IE 7]> 
<link href="<%=basePath%>/css/main.ie7.css" rel="stylesheet" type="text/css" />
<![endif]-->
<script type="text/javascript" src="<%=basePath%>/js/jquery-1.5.1.min.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/jquery-imgslideshow.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/ks-switch.js"></script>
...
<div id="doc">
	<div id="s_hdw">
		...
		<div class="s_hd nav">
			<div id="s_logo"><a href="#"><img src="<%=basePath%>/images/logo.png" border="0" /></a></div>
			<div id="s_nav">
				<ul>
		...
		<div class="mmenu">
			<div class="s_hd">
				<div id="s_search">
					<form action="" method="post"><input name="" type="text" class="search-input" /><input name="" type="image" src="<%=basePath%>/images/btn_search.jpg" /></form>
				</div>
	...
	<link type="text/css" href="<%=basePath%>/css/lr.css" rel="stylesheet" />
	...
	<div id="s_bdw">
		<div id="s_bd">
					...
					<form id="formlogin" method="post" onsubmit="return false;">
						...
						<div class="form" style="width:600px;">
							<div class="item">
								...
								<div class="fl">
									<input type="text" id="loginname" name="usernameOrEmail" class="text" tabindex="1" value=""/>
						...
						<div id="guide">
							...
							<a href="users/toReg" class="btn-personal">注册新用户</a>
			...
			<script type="text/javascript" src="<%=basePath%>/js/Validate.entry.js"></script>
	...
	<div id="s_ftw">
		...
		<div id="s_ft">
			...
			<div class="ft_banners1 tac pbt10">
				<ul>
					<li><a href="#"><img src="<%=basePath%>/images/ft_1.gif" border="0" /></a></li>
					<li><a href="#"><img src="<%=basePath%>/images/ft_2.gif" border="0" /></a></li>
					<li><a href="#"><img src="<%=basePath%>/images/ft_3.gif" border="0" /></a></li>
				</ul>
			</div>
			<div class="copyright tac pbt10">版权所有 Copyright&copy; EGO商城 All Rights Reserved 版权所有 </div>
			<div class="ft_banners2 tac">
				<ul>
					<li><a href="#"><img src="<%=basePath%>/images/u255.png" border="0" /></a></li>
					<li><a href="#"><img src="<%=basePath%>/images/u257.png" border="0" /></a></li>
					<li><a href="#"><img src="<%=basePath%>/images/u259.png" border="0" /></a></li>
					<li><a href="#"><img src="<%=basePath%>/images/u261.png" border="0" /></a></li>
				</ul>
			</div>
		</div>
