...
<div id="doc">
	...
	<div id="s_bdw">
		<div id="s_bd">
				...
				<div class="dl-con" id="regist">
					<form id="formpersonal" method="post" onsubmit="return false;">
						...
						<div class="form">
							...
							<div class="item">
								<span class="label">邮箱或用户名：</span>
								<div class="fl">
									<input type="text" id="usernameOrmail" name="usernameOrmail" class="text" tabindex="4"/>
			...
			<script type="text/javascript" src="<%=basePath%>/js/Validate.personal.js"></script>
