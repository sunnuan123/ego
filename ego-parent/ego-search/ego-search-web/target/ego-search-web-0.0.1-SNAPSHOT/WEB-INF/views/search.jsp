...
<div id="doc">
	<div id="s_hdw">
		...
		<div class="mmenu">
			<div class="s_hd">
				<div id="s_search">
					<form action="" id="s_search_form" method="" onsubmit="return false;">
					<input type="hidden" name="currentPage" id="currentPage" value="1"/>
					<input type="hidden" name="pageSize" id="pageSize" value="12"/>
					<input name="keywords" value="${keywords }" id="keywords" type="text" class="search-input" />
					<input name="" type="image" src="images/btn_search.jpg" onclick="doSearch()" /></form>
				</div>
	...
	<div id="s_bdw">
		<div id="s_bd">
			...
			<div class="breadcrumbs">
				<div class="f-l"><a href="#">全部结果</a><span>»</span><a href="#"> 手机 /	运营商 /	数码 </a><span>»</span><a href="#">手机通信</a><span>»</span>手机</div>
			...
			<div class="f-r rightlist">
				...
				<div class="pagecon" id="pagination" style="float: right;">
				</div>
...
function doSearch(currentPage,pageSize){
	...
	$.post("doSearch",{"keywords":keywords,"currentPage":currentPage,"pageSize":pageSize},function(page){
		var html_rows = '';
		//展示列表
		$.each(page.rows,function(i,v){
			html_rows += '<li>';
			html_rows += '<a href="#"><img src="'+v.originalImg+'" width="170" height="160" alt="" /></a>';
			html_rows += '<dl>';
			html_rows += '<dt><a href="#">'+v.goodsNameHl+'</a></dt>';
			html_rows += '<dd>特价：<strong class="red">￥'+v.shopPrice+'</strong></dd>';
			html_rows += '<dd><span class="startotal"></span></dd>';
			html_rows += '<dd><a class="addcat" href="#">加入购物车</a></dd>';
			html_rows += '</dl>';
			html_rows += '</li>';
		})
		$("#productlist_ul").html(html_rows);
		showPage(page.total,page.currentPage);
		layer.close(index);
	});
}

//分页方法
function showPage(total,currentPage){
